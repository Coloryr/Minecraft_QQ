...
public class SideVelocity implements IMinecraft_QQ {
    ...
    public void message(String message) {
        try {
            ...
            while (msg.indexOf(Minecraft_QQ.Config.System.Head) == 0 && msg.contains(Minecraft_QQ.Config.System.End)) {
                String buff = Function.get_string(msg, Minecraft_QQ.Config.System.Head, Minecraft_QQ.Config.System.End);
                ReadOBJ readobj;
                try {
                ...
                int i = msg.indexOf(Minecraft_QQ.Config.System.End);
                msg = msg.substring(i + Minecraft_QQ.Config.System.End.length());
            }
        } catch (Exception e) {
